...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function UsageDock(props) {
      ...
      var [positionPref, setPositionPref] = useState(loadPosition)
      ...
      // glass preference (localStorage-backed; applied live to the strip)
      var [glass, setGlass] = useState(loadGlass)

      var stripRef = useRef(null)
      var panelRef = useRef(null)
      var mounted = useRef(true)

      var active = position === positionPref

      var updateGlass = function (patch) {
        setGlass(function (prev) {
      ...
      var resetGlass = function () {
        var defaults = Object.assign({}, GLASS_DEFAULTS)
        saveGlass(defaults)
        setGlass(defaults)
      }
      ...
      if (panelOpen) {
        ...
        panel = jsx('div', { ref: panelRef, className: 'dshub-panel', style: panelStyle, children: jsxs(Fragment, { children: [
          ...
          jsxs('div', { className: 'dshub-panel-cols', children: [
            jsx('div', { className: 'dshub-panel-col', children: jsxs(Fragment, { children: [tokenStep, howTo] }) }),
      ...
      // Below-position strips live inside the composer card's footer, which
      // is already width-constrained — span it fully instead of re-centering.
      var positionedStripStyle = Object.assign({}, stripStyle, position === 'below'
        ? { width: '100%', maxWidth: 'none', margin: '4px 0 0', borderRadius: 10 }
        : {})
